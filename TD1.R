...
echantillon3 = rnorm(n = 2000, mean = 0, sd = 1)

quantile(echantillon3, probs = c(0.25))
quantile(echantillon3, probs = c(0.50))
quantile(echantillon3, probs = c(0.75))
quantile(echantillon3, probs = seq(0,1,0.1))
quantile(echantillon3, probs = seq(0,1,0.01))

echantillon4 = rnorm(n = 3000, mean = 2400, sd = 300)
moyenne = mean(echantillon4)
et = sd(echantillon4)

arrondir = round(echantillon4, 2)
massesal = sum(echantillon4)
salmed = median(echantillon4)
